...
import weifen.com.common.utils.AndroidBug5497Workaround;
import weifen.com.eclife.R;
import weifen.com.eclife.fragment.ConversationFragmentEx;
 ...
 * 3，push 和 通知 判断
 */
public class ServiceConversationActivity extends FragmentActivity implements View.OnClickListener {

    private String TAG = ServiceConversationActivity.class.getSimpleName();
    /**
     * 对方id
     */
    ...
    private ImageView back,changeContact,goodImage,badImage;
    private TextView tvTitle;
    private LinearLayout good,bad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.service_conversation);
        ...
        changeContact= (ImageView) findViewById(R.id.change_contact);
        goodImage= (ImageView) findViewById(R.id.good_image);
        badImage= (ImageView) findViewById(R.id.bad_image);
    ...
    private void enterFragment(Conversation.ConversationType mConversationType, String mTargetId) {
        ...
        Uri uri = Uri.parse("rong://" + getApplicationInfo().packageName).buildUpon()
                .appendPath("service_conversation").appendPath(mConversationType.getName().toLowerCase())
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.change_contact:
                RequestResult.changeService(this,"204",tvTitle.getText()+"");
                break;
            //好评
            case R.id.good:
                bad.setEnabled(false);
                good.setEnabled(false);
                goodImage.setImageResource(R.mipmap.good2);
                RequestResult.changeService(this,"205",tvTitle.getText()+"");
                break;
            //差评
            case R.id.bad:
                bad.setEnabled(false);
                good.setEnabled(false);
                badImage.setImageResource(R.mipmap.not_good2);
                RequestResult.changeService(this,"206",tvTitle.getText()+"");
                break;
        }
    }
}
